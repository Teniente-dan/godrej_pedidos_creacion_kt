		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#PedidosVentas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PedidosVentas-display": {
								"semanticObject": "PedidosVentas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=godrej.pedidoscrea",
									"url": sap.ui.require.toUrl("godrej/pedidoscrea")
								}
							}
						}
					}
